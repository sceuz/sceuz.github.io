(() => {
  ...
  const english = {
    ...
    'ML-разработка, исследовательские проекты, робототехника, embedded-системы и преподавание.': 'ML development, research projects, robotics, embedded systems, and teaching.',
    'Июнь 2025 — сейчас': 'June 2025 — Present',
    'ООО «ТТК ДИДЖИТАЛ»': 'TTK DIGITAL LLC',
    'Разрабатываю и проверяю ML-модели, готовлю данные для задач компьютерного зрения и соединяю алгоритмы с симуляцией и реальной аппаратной частью роботов.': 'I develop and validate ML models, prepare data for computer vision tasks, and connect algorithms with simulation and real robot hardware.',
    'ML и данные': 'ML and Data',
    'Сборка и разметка датасетов, проверка качества данных и подготовка выборок к обучению': 'Dataset collection and annotation, data quality checks, and training-set preparation',
    'Обучение, проверка и анализ моделей на Python с PyTorch и TensorFlow/Keras': 'Model training, validation, and analysis in Python with PyTorch and TensorFlow/Keras',
    'Обработка видеопотока, computer vision и слежение за AprilTag': 'Video processing, computer vision, and AprilTag tracking',
    'Робототехника и embedded': 'Robotics and Embedded',
    'Настройка симуляций в NVIDIA Isaac Sim и Isaac Lab, проверка checkpoint-моделей и sim-to-real': 'Simulation setup in NVIDIA Isaac Sim and Isaac Lab, checkpoint validation, and sim-to-real workflows',
    'Программирование, прошивка и отладка STM32 и других микроконтроллеров': 'Programming, firmware development, and debugging for STM32 and other microcontrollers',
    '3D-моделирование деталей и узлов, подготовка геометрии для сборки, тестирования и симуляции': '3D modeling of parts and assemblies, with geometry prepared for assembly, testing, and simulation',
    'Работа с актуаторами, датчиками, управляющими сигналами и ограничениями приводов': 'Working with actuators, sensors, control signals, and drive constraints',
    'Технологии в ТТК ДИДЖИТАЛ': 'Technologies used at TTK DIGITAL',
